        ...
        <ul class="app-menu">
            <li class="treeview is-expanded">
                <a class="app-menu__item" href="#" data-toggle="treeview">
                    <i class="fas fa-th-large app-menu__icon"></i>
                    <span class="app-menu__label">Danh mục</span>
                    <i class="treeview-indicator fa fa-angle-right"></i>
                </a>
                <ul class="treeview-menu">
                    <li>
                        <a class="treeview-item active" href="bootstrap-components.html">
                            <i class="far fa-hat-chef icon"></i>
                            Công thức nấu ăn
                        </a>
                    </li>
                    <li>
                        <a class="treeview-item" href="https://fontawesome.com/v4.7.0/icons/">
                            <i class="far fa-lightbulb-on icon"></i>
                            Mẹo vặt
                        </a>
                    </li>
                    <li>
